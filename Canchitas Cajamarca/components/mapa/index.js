...
(function(parent) {
    var dataProvider = app.data.backendServices,
        ...
        fetchFilteredData = function(paramFilter, searchFilter) {
            ...
            if (model) {
                ...
                parent.set('mapaModel_delayedFetch', paramFilter || null);
                return;
            }
        ...
        mapaModel = kendo.observable({
            ...
            detailsShow: function(e) {
                ...
                mapaModel.setCurrentItemByUid(uid);
            ...
            setCurrentItemByUid: function(uid) {
                ...
                mapaModel.set('originalItem', itemModel);
                mapaModel.set('currentItem',
                    mapaModel.fixHierarchicalData(itemModel));
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            ...
            var param = parent.get('mapaModel_delayedFetch');
            if (typeof param !== 'undefined') {
                parent.set('mapaModel_delayedFetch', undefined);
    ...
    parent.set('onShow', function(e) {
        var param = e.view.params.filter ? JSON.parse(e.view.params.filter) : null,
            ...
            dataSourceOptions = mapaModel.get('_dataSourceOptions'),
            dataSource;
